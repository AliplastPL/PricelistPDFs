...
,t0.pgdesc as "Desc."
,t0.pgstun as "Price Unit"
,t1.ppprcu as "Sales Unit"
,t1.ppsalp as "MF"
,t2.ppsalp as "T"
,t3.ppsalp as "N"
...
where
t0.pgstat<>'D' and t0.pghstc='' and (t0.PGPPGR ='CPL' OR pgpgrp = 'SS') and pgprcl in ('1','2')  and t0.PGPPGR <>'XPL'

--wyklucza magazynowki
...
t0.pgstat<>'D' and t0.pghstc='' and (t0.PGPPGR ='CPL' OR pgpgrp = 'SS') and pgprcl in ('1','2')
--wybiera magazynowki
...
left join ali800cfap.sropps t2 on t2.ppprdc=replace(case when locate('/',t0.pgprdc)>0 then
substring(pgprdc,1,locate('/',t0.pgprdc)-1) else t0.pgprdc end,' ','') and t2.pppril='{n}T' and t2.pptodt=0
...
--wyklucza anody i magazynowke
--warunek dotychczasowy: and t0.pgprdc not like '%/8019%' and t0.pgprdc not like '%/9006%' and t0.pgprdc not like '%/9016%' and t0.pgprdc not like '%/AN%' and t0.pgprdc not like '%/LAN%' and t0.pgprdc not like '%/INOX%'
...
and t0.pgprcl in ('1','2') and t0.pgppgr in ('CPL')
--wybiera anody i magazynowke
and (t0.pgprdc like '%/8019%' or t0.pgprdc like '%/9006%' or t0.pgprdc like '%/9016%' or t0.pgprdc like '%/3800%' or t0.pgprdc like '%/6029%' or t0.pgprdc like '%/7016%' or t0.pgprdc like '%/9005%' or t0.pgprdc like '%/9010%')
),
...
--wybiera akcesoria bez MFa
--opcja 1:
--and (select x0.pgprdc from ali800cfap.sroprg x0 where pgstat<>'D' and x0.pgprdc=concat(replace(t0.pgprdc,' ',''),'/MF')) is null
--opcja 2:
...
q6 as (
--6) AKCESORIA W SURÓWCE I LAKIERZE jeśli MF jest zablokowany, tymczasowe obejscie na stringach (trzeba to kiedys poprawic bo to tragiczne rozwiazanie)
...
--wybiera akcesoria
and (t0.pgprdc like 'AC%' or t0.pgprdc like 'FAZE%' or t0.pgprdc like 'M1%' or t0.pgprdc like 'M2%' or t0.pgprdc like 'M3%' or t0.pgprdc like 'M4%' or t0.pgprdc like 'M5%' or t0.pgprdc like 'M6%' or t0.pgprdc like 'M7%' or t0.pgprdc like 'M8%' or t0.pgprdc like 'M9%' or t0.pgprdc like 'LWB%' or t0.pgprdc like 'LOB%' or t0.pgprdc like 'CMC%' or t0.pgprdc like 'LWC%'  or t0.pgprdc like 'CAH%' or t0.pgprdc like 'PKDP%' or t0.pgprdc like 'GS1%' or t0.pgprdc like 'GS2%' or t0.pgprdc like 'GS3%' or t0.pgprdc like 'GS4%' or t0.pgprdc like 'GS5%' or t0.pgprdc like 'GS6%' or t0.pgprdc like 'GS7%' or t0.pgprdc like 'GS8%'or t0.pgprdc like 'GS9%' or t0.pgprdc like 'GS0%' or t0.pgprdc like 'AFT%' or t0.pgprdc like 'AFWL%' or t0.pgprdc like 'SLO%' or t0.pgprdc like 'SLD%' or t0.pgprdc like 'SLF%' or t0.pgprdc like 'SLI%' or t0.pgprdc like 'SLC%' or t0.pgprdc like 'ALI%')
and t0.pgprcl in ('1','2') --and t0.pgppgr = 'XPL'
and (t0.pgprdc like '%/MF%' or t0.pgprdc not like '%/%')
...
, case when t7.srufn3=0 then 1 else t7.srufn3 end 
...
left join ali800cfap.sroprx t5 on t0.pgprdc=t5.pxprdc and t5.pxlang='PL' and t5.PXTLIN=1
